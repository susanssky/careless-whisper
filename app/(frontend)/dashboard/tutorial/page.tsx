...
export default function tutorialPage() {
  ...
  return (
    <>
      Note: If you have the NVIDIA GPU, the transcript process will be faster
      than using a CPU.
      <ol className="list-decimal my-6 ml-3 [&>li]:mt-5">
        ...
        <li>
          Wait patiently for the transcript process to complete. Once finished,
          several output files will be generated. You can upload the SRT file to
